...
CellNeighbourhood newCellNeighbourhood(CellValue nw, CellValue n, CellValue ne, CellValue w, CellValue c, CellValue e,
                                       CellValue sw, CellValue s, CellValue se) {
...
int surroundingSum(CellNeighbourhood n) {
    return n.nw.occ.se + n.n.occ.s + n.ne.occ.sw + n.w.occ.e + +n.c.occ.c + n.e.occ.w + n.sw.occ.ne + n.s.occ.n +
           n.se.occ.nw;
}
